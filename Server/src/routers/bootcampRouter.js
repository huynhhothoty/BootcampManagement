...
BCRouter.route('/:id/export').get(authorize('leader', 'admin'), ExportController.exportFileExcel);
...
BCRouter.route('/user/:id').get(authorize('leader', 'admin'), BCController.findAllBCOfUser);
//
