import { MISSING_FIELD_INFO, NO_ALLOWCATION_CREDITS_DATA } from "../constants/errorMessage";

export const validateBootcampData = (bootcampName,totalCredits,allowcateFields, semesterList, semesterSubjectList, completeTotalCredits) => {
  ...
  if (totalCredits <= 0) {
    ...
    if(completeTotalCredits !== totalCredits) tempErrorMessage.completeTotalCredits = true
  }
  ...
  tempErrorMessage.remainning = semesterSubjectList.some(
    (subject) =>
